...
- Evolution: With the help of claude, i refined the logic into C++ to improve performance, learn the inticracies of the language, and to get python to not be so damn buggy
